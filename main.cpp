...
int main(int argc, char** argv)
{
    ...
    road.SetLength(300 * 100);
    road.AddRightSection({ RoadRunnder::RoadProfile{-1, 1}, 0 * 100 });
    road.AddRightSection({ RoadRunnder::RoadProfile{1, 2}, 120 * 100 });
    road.AddRightSection({ RoadRunnder::RoadProfile{-1, 1}, 180 * 100 });

    road.AddLeftSection({ RoadRunnder::RoadProfile{-1, 2}, 0 * 100 });
    road.AddLeftSection({ RoadRunnder::RoadProfile{1, 1}, 60 * 100 });
    road.AddLeftSection({ RoadRunnder::RoadProfile{-1, 2}, 240 * 100 });
