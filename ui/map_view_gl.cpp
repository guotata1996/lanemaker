...
namespace RoadRunner
{
    ...
    size_t MapViewGL::AddQuads(const odr::Line3D& lBorder, const odr::Line3D& rBorder)
    {
        ...
        // TODO: mapRange update m_vbo / ebo
    ...
    void MapViewGL::RemoveItem(size_t)
    {
    ...
    void MapViewGL::initializeGL()
    {
        ...
        //m_vertexBufferData.push_back(Vertex(QVector3D(0, 0, 0), QColor(255, 128, 64)));
        //m_vertexBufferData.push_back(Vertex(QVector3D(10, 8, 0), QColor(255, 128, 64)));
        //m_vertexBufferData.push_back(Vertex(QVector3D(0, 12, -9), QColor(255, 128, 64)));
        //m_elementBufferData.push_back(0);
        //m_elementBufferData.push_back(1);
        //m_elementBufferData.push_back(2);
